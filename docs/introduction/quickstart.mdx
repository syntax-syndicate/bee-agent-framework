...
<Steps>
  ...
  <Step title="Configure your LLM Backend">
   ...
   If you choose to run a local model, [Ollama](https://ollama.com/) must be installed and running, with the [granite3.3](https://ollama.com/library/granite3.3) model pulled.
  ...
  LLM_CHAT_MODEL_NAME="openai:gpt-5-mini-2025-08-07"
  ```

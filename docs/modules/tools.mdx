...
| [VectorStoreSearch](#vector-store-search) | Search for relevant documents in a vector store using semantic similarity                         |
| [Python](#python)     | Run arbitrary Python code in a sandboxed environment                                                |

...
|:-----------------------------------------------------|:--------------------------------------------|:---------------------------|
| [A2A](https://a2a-protocol.org/)       | `beeai_framework.adapters.a2a.serve`         | `beeai-framework[a2a]`       |
| [Agent Stack](https://beeai.dev/)                | `beeai_framework.adapters.agentstack.serve` | `beeai-framework[agentstack]` |
| [MCP](https://modelcontextprotocol.io/) | `beeai_framework.adapters.mcp.serve`         | `beeai-framework[mcp]`       |
